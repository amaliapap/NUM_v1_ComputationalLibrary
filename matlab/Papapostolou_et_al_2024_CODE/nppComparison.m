...
% and save to the folder: "NPP satellite data"
% Standard VGPM, Eppley-VGPM, CbPM2, CAFE
%
function nppComparison(sim)


if exist("../../data/cbpm_mean_2003_2019.mat")
    showData = true;
else
    showData = false;
end
...
if showData==true
    %addpath(append(pwd,path_to_NPP_data))

    % NPPcafeVsNUMfinal(sim)
    % load('npp_climatlogy_cafe_2002_2020.mat','npp')
    load('../../data/cafe_mean_2003_2019.mat','mat_cafe')
    load('../../data/cbpm_mean_2003_2019.mat','mat_cbpm')
    load('../../data/vgpm_mean_2003_2019.mat','mat_vgpm')
    load('../../data/vgpme_mean_2003_2019.mat','mat_vgpme')
