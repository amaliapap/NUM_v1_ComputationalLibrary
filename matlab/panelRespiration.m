...
fillbetweenlines(m, 0*jR, jR, ccmap2(1,:));
hold on
...
%         jR_g
        ...
        fillbetweenlines(m, jR, jR+jR_DOC, ccmap2(2,:));
        fillbetweenlines(m, jR+jR_DOC, jR+jR_DOC+jR_L, ccmap2(3,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L, jR+jR_DOC+jR_L+jR_N, ccmap2(4,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N, jR+jR_DOC+jR_L+jR_N+jR_F, ccmap2(5,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_F, jR+jR_DOC+jR_L+jR_N+jR_F+jR_g, ccmap2(7,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_F+jR_g, jR+jR_DOC+jR_L+jR_N+jR_F+jR_g+jTot, ccmap2(8,:) );
...
%         jR_g = betaG*rates.jTot(ix);
        ...
        fillbetweenlines(m, jR+jR_DOC, jR+jR_DOC+jR_L, ccmap2(3,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L, jR+jR_DOC+jR_L+jR_N, ccmap2(4,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N, jR+jR_DOC+jR_L+jR_N+jR_Si, ccmap2(6,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_Si, jR+jR_DOC+jR_L+jR_N+jR_Si+jR_g, ccmap2(7,:));
        fillbetweenlines(m, jR+jR_DOC+jR_L+jR_N+jR_Si+jR_g, jR+jR_DOC+jR_L+jR_N+jR_Si+jR_g+max(0,jTot), ccmap2(8,:) );
